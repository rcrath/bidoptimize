...
C:\windows\system32\taskkill.exe /f /IM GoogleCrashHandler.exe /T

C:\windows\system32\taskkill.exe /f /IM GoogleCrashHandler64.exe /T
...
C:\windows\system32\taskkill.exe /f /IM OfficeClickToRun.exe /T

C:\windows\system32\taskkill.exe /IM OneDrive.exe /T

C:\windows\system32\taskkill.exe /f /IM Pen_Tablet.exe /T

C:\windows\system32\taskkill.exe /f /IM Pen_TabletUser.exe /T

C:\windows\system32\taskkill.exe /f /IM Pen_TouchUser.exe /T

C:\windows\system32\taskkill.exe /f /IM pia-service.exe /T

C:\windows\system32\taskkill.exe /f /IM SearchApp.exe /T

C:\windows\system32\taskkill.exe /IM  SearchIndexer.exe /T

rem onscreen keyboard for typing
C:\windows\system32\taskkill.exe /IM  WacomHost.exe /T

C:\windows\system32\taskkill.exe /f /IM WTabletServiceCon.exe /T
...
rem NET START "LicenseManager" 

NET START "NcdAutoSetup" 
rem Network Connection Broker Service
rem NET START "NcbService" /yes

NET START "NIHardwareService" 

rem remote access mgr
rem NET START "RasMan" 

rem bluetooth stuff
rem NET START "RtkBtManServ" 

rem win backup
rem NET START "SDRSVC" 
...
rem NET START "SstpSvc" 

rem Still Image Acquisition
rem NET START "stisvc" 

rem connect to remote desktops
rem NET START "TermService" /yes
...
rem Block Level Backup Engine Service
rem NET START "wbengine" 

rem Microsoft Account Sign-in Assistant
rem NET START "wlidsvc" 
